			...
			<div className="space-y-4">
				...
				<div className="card">
					...
					<p className="text-text-muted text-xs mt-3">
						Para trocar o modelo: edite{" "}
						<code className="bg-bg-elevated px-1 rounded">OLLAMA_MODEL</code> no{" "}
						<code className="bg-bg-elevated px-1 rounded">.env</code> e reinicie
						o Docker.
					</p>
				</div>
				...
				<div className="card">
					<div className="flex items-center gap-3 mb-3">
						...
						{!loading &&
							(config?.n8n_configured ? (
								<CheckCircle
									size={14}
									className="text-status-published ml-auto"
								/>
							) : (
					...
					<p className="text-text-muted text-xs">
						O n8n consulta posts agendados a cada 5 minutos e publica
						automaticamente.
					</p>
				...
				<div className="card">
					...
					<p className="text-text-muted text-xs">
						Configure{" "}
						<code className="bg-bg-elevated px-1 rounded">DATABASE_URL</code> no{" "}
						<code className="bg-bg-elevated px-1 rounded">.env</code> com a URL
						do Supabase. Veja{" "}
						<code className="bg-bg-elevated px-1 rounded">
