...
import {
  Calendar, BookOpen, Sparkles, LayoutList, Settings, LogOut, Zap, Layers
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  // Sem post escolhido, /carousel leva ao Pipeline (ver App.jsx)
  { to: "/carousel", icon: Layers, label: "Carrossel" },
